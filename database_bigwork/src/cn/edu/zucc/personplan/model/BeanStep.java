...
public class BeanStep {
	public static BeanStep currentStep=null;
	public static final String[] tblStepTitle={"序号","名称","计划开始时间","计划完成时间","实际开始时间","实际完成时间","创建时间"};
	// 增加 planId
	/**
	...
	public String getCell(int col){
		...
		else if(col==6) return String.valueOf(create_time); //创建时间
		else return "";
	}
