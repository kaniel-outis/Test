...
public class FrmDleteUser extends JFrame implements ActionListener {
		//new
		...
		private JButton btnOk = new JButton("确定删除");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnOk){	
			...
			try {
				PersonPlanUtil.userManager.deleteUser(this.allUser.get(i));
				System.out.println(this.allUser.get(i).getUser_id());
